...
DEST_DIRECTORY_TRAIN = 'DeepSPTTrajectories'
DEST_DIRECTORY_VAL = 'DeepSPTTrajectories_val'

os.makedirs(DEST_DIRECTORY_TRAIN, exist_ok=True)
os.makedirs(DEST_DIRECTORY_VAL, exist_ok=True)

transform_cache_file_chuck_files(glob.glob('*train*_segmentated_trajectories.cache'), DEST_DIRECTORY_TRAIN, 'classifier')
transform_cache_file_chuck_files(glob.glob('*val*_segmentated_trajectories.cache'), DEST_DIRECTORY_VAL, 'classifier')

...
from .model_utils import transform_trajectories_to_anomalous_exponent
...
class LSTMAnomalousExponentPredicter(PredictiveModel):
    ...
    def classify_with_combination(cls, trajectories, list_of_classifiers):
        ...
        Y_predicted = many_net_uhd(nets = meta_model_class_2d, traj_set = X, centers = centers_class_2d ,dim = 2, task = 1)

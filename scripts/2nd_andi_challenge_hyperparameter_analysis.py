...
WavenetTCNMultiTaskSingleLevelPredicter.plot_hyperparameter_search(L, L, simulator=Andi2ndDataSimulation, discriminator={'lr': 0.0001, 'batch_size': 32, 'amsgrad': False, 'epsilon': 1e-06, 'epochs':7})
